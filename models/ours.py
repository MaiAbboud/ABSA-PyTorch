...
class OURS(nn.Module):
    def __init__(self,bert, embedding_matrix, opt):
        ...
        self.pe = PositionalEncoding(d_model=opt.embed_dim)

    def forward(self, inputs):
        text_indices = inputs[0] # batch_size x seq_len
        aspect_indices = inputs[1] # batch_size x seq_len
        # text_indices_bert = inputs[2] # batch_size x seq_len
        # aspect_indices_bert = inputs[3] # batch_size x seq_len
